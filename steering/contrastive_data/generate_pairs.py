...
Reimplementation notice: the script that produced the existing
data/value/*_context_controlled.csv files was lost when the NCI Gadi HPC
working directory was cleaned up. VISPA's own generation procedure follows
ConVA (Jin et al., ACL 2025 / arXiv:2507.11316), generalized from their
original 10 Schwartz values to all 31 values in this repo's taxonomy
(value_selection/values.py). ConVA's own generation script was likewise
never published; this is rebuilt from the paper's description of the
two-stage procedure:
